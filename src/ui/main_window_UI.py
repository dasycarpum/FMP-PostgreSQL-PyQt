...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.rdbms = QtWidgets.QWidget()
        self.rdbms.setObjectName("rdbms")
        self.gridLayout = QtWidgets.QGridLayout(self.rdbms)
        self.gridLayout.setObjectName("gridLayout")
        self.comboBox_reporting = QtWidgets.QComboBox(parent=self.rdbms)
        ...
        self.lineEdit_reporting = QtWidgets.QLineEdit(parent=self.rdbms)
        ...
        self.tabWidget_reporting = QtWidgets.QTabWidget(parent=self.rdbms)
        ...
        self.tabWidget.addTab(self.rdbms, "")
        self.tabWidget_dividend = QtWidgets.QWidget()
        self.tabWidget_dividend.setObjectName("tabWidget_dividend")
        self.gridLayout_dividend = QtWidgets.QGridLayout(self.tabWidget_dividend)
        self.gridLayout_dividend.setObjectName("gridLayout_dividend")
        self.pushButton_modify_date = QtWidgets.QPushButton(parent=self.tabWidget_dividend)
        self.pushButton_modify_date.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.pushButton_modify_date.setObjectName("pushButton_modify_date")
        self.gridLayout_dividend.addWidget(self.pushButton_modify_date, 7, 2, 1, 1)
        self.label_adjustement_2 = QtWidgets.QLabel(parent=self.tabWidget_dividend)
        self.label_adjustement_2.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.label_adjustement_2.setObjectName("label_adjustement_2")
        self.gridLayout_dividend.addWidget(self.label_adjustement_2, 4, 1, 1, 1)
        self.pushButton_accept_date = QtWidgets.QPushButton(parent=self.tabWidget_dividend)
        self.pushButton_accept_date.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.pushButton_accept_date.setObjectName("pushButton_accept_date")
        self.gridLayout_dividend.addWidget(self.pushButton_accept_date, 5, 2, 1, 1)
        self.pushButton_next_stock = QtWidgets.QPushButton(parent=self.tabWidget_dividend)
        self.pushButton_next_stock.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.pushButton_next_stock.setObjectName("pushButton_next_stock")
        self.gridLayout_dividend.addWidget(self.pushButton_next_stock, 10, 2, 1, 1)
        self.tableWidget_dividend = QtWidgets.QTableWidget(parent=self.tabWidget_dividend)
        self.tableWidget_dividend.setObjectName("tableWidget_dividend")
        self.tableWidget_dividend.setColumnCount(0)
        self.tableWidget_dividend.setRowCount(0)
        self.gridLayout_dividend.addWidget(self.tableWidget_dividend, 1, 1, 3, 2)
        self.dateEdit_dividend = QtWidgets.QDateEdit(parent=self.tabWidget_dividend)
        self.dateEdit_dividend.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.dateEdit_dividend.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.dateEdit_dividend.setObjectName("dateEdit_dividend")
        self.gridLayout_dividend.addWidget(self.dateEdit_dividend, 6, 2, 1, 1)
        self.textBrowser_dividend = QtWidgets.QTextBrowser(parent=self.tabWidget_dividend)
        self.textBrowser_dividend.setObjectName("textBrowser_dividend")
        self.gridLayout_dividend.addWidget(self.textBrowser_dividend, 5, 1, 6, 1)
        spacerItem2 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        self.gridLayout_dividend.addItem(spacerItem2, 9, 2, 1, 1)
        self.label_adjustement_1 = QtWidgets.QLabel(parent=self.tabWidget_dividend)
        self.label_adjustement_1.setMaximumSize(QtCore.QSize(16777215, 20))
        self.label_adjustement_1.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.label_adjustement_1.setObjectName("label_adjustement_1")
        self.gridLayout_dividend.addWidget(self.label_adjustement_1, 0, 1, 1, 1)
        self.label_dividend = QtWidgets.QLabel(parent=self.tabWidget_dividend)
        self.label_dividend.setMaximumSize(QtCore.QSize(16777215, 20))
        self.label_dividend.setAlignment(QtCore.Qt.AlignmentFlag.AlignCenter)
        self.label_dividend.setObjectName("label_dividend")
        self.gridLayout_dividend.addWidget(self.label_dividend, 0, 0, 1, 1)
        self.calendarWidget_dividend = QtWidgets.QCalendarWidget(parent=self.tabWidget_dividend)
        self.calendarWidget_dividend.setCursor(QtGui.QCursor(QtCore.Qt.CursorShape.PointingHandCursor))
        self.calendarWidget_dividend.setObjectName("calendarWidget_dividend")
        self.gridLayout_dividend.addWidget(self.calendarWidget_dividend, 1, 0, 1, 1)
        self.treeWidget_dividend = QtWidgets.QTreeWidget(parent=self.tabWidget_dividend)
        self.treeWidget_dividend.setObjectName("treeWidget_dividend")
        self.treeWidget_dividend.headerItem().setText(0, "1")
        self.gridLayout_dividend.addWidget(self.treeWidget_dividend, 2, 0, 9, 1)
        self.gridLayout_dividend.setColumnStretch(0, 1)
        self.gridLayout_dividend.setColumnStretch(1, 3)
        self.gridLayout_dividend.setRowStretch(0, 1)
        self.gridLayout_dividend.setRowStretch(1, 1)
        self.gridLayout_dividend.setRowStretch(2, 3)
        self.tabWidget.addTab(self.tabWidget_dividend, "")
        ...
        self.action_schedule = QtGui.QAction(parent=MainWindow)
        self.action_schedule.setObjectName("action_schedule")
        self.action_price_adjustment = QtGui.QAction(parent=MainWindow)
        self.action_price_adjustment.setObjectName("action_price_adjustment")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.rdbms), _translate("MainWindow", "RDBMS reporting"))
        self.pushButton_modify_date.setText(_translate("MainWindow", "Modify and \n"
"Accept the date"))
        self.label_adjustement_2.setText(_translate("MainWindow", "Closing price adjustment following ex-dividend date"))
        self.pushButton_accept_date.setText(_translate("MainWindow", "Accept the\n"
"suggested date"))
        self.pushButton_next_stock.setText(_translate("MainWindow", "Next stock"))
        self.label_adjustement_1.setText(_translate("MainWindow", "Click on a stock to manage its price adjustment..."))
        self.label_dividend.setText(_translate("MainWindow", "Click on a date for more details and adjustments..."))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabWidget_dividend), _translate("MainWindow", "Dividend management"))
        ...
        self.action_schedule.setText(_translate("MainWindow", "Schedule"))
        self.action_price_adjustment.setText(_translate("MainWindow", "Price adjustment"))
